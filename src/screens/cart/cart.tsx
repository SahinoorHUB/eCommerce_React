            ...
            <div className="card border shadow-0">
                ...
                {items.map((item, index) => {
                  return (
                    <div className="row gy-3 mb-4" key={index}>
                      ...
                      <div className="col-lg-2 col-sm-6 col-6 d-flex  justify-content-xl-end mb-2">
                        <div className="price-div"><span className="price-tag">₹{item.totalPrice}</span></div>
                      </div>
              ...
              {items && items.length > 0 && (
                <div className="m-4 totalShow">
                  <div className="price-div"><span className="price-tag">TOTAL AMOUNT: ₹ {getTotalAmount}</span></div>
                </div>
              )} 
              {items.length === 0 && (
                <div className="m-4 mt-0">
                  <div className="price-div"><span className="price-tag">NO CART ADDED</span></div>
                </div>
              )}
            </div>
          </div>
